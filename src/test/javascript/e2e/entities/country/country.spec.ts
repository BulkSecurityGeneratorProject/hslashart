...
describe('Country e2e test', () => {
    ...
    it('should load Countries', async () => {
        ...
        expect(await countryComponentsPage.getTitle()).to.eq('hslashartApp.country.home.title');
    });
    ...
    it('should load create Country page', async () => {
        ...
        expect(await countryUpdatePage.getPageTitle()).to.eq('hslashartApp.country.home.createOrEditLabel');
    ...
    it('should delete last Country', async () => {
        ...
        expect(await countryDeleteDialog.getDialogTitle()).to.eq('hslashartApp.country.delete.question');
