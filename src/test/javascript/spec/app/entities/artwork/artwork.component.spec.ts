...
import { ArtworkComponent } from 'app/entities/artwork/artwork.component';
    ...
    describe('Artwork Management Component', () => {
        ...
        beforeEach(() => {
            TestBed.configureTestingModule({
                ...
                .overrideTemplate(ArtworkComponent, '')
                .compileComponents();
        ...
        it('Should call load all on init', () => {
            ...
            expect(comp.artworks[0]).toEqual(jasmine.objectContaining({ id: '123' }));
        });
